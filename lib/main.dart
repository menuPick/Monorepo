    ...
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (context, mode, child) {
        return MaterialApp(
          ...
          routes: {
            AppRoutes.recommend: (_) => const RecommendationInputPage(),
            AppRoutes.result: (_) => const RecommendationResultPage(),
          ...
          child: Column(
            ...
            children: [
              ...
              EntranceBlurSlide(
                ...
                child: _PromoCard(
                  onTap: () {
                    Navigator.of(context).pushNamed(AppRoutes.recommend);
                  },
